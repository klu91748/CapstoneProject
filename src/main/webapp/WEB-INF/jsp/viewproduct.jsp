...
<body>
	...
	<div class="mx-auto w-75">
		...
		<h4 class="text-secondary">Here is the detail information of the
			product!</h4>
		<table class="table" id="example">
			<tbody>
				...
				<tr>
					<td><a class="btn btn-secondary" href="/products"
						type="button">Back</a> <a type="button" class="btn btn-warning"
						href="/user/addproduct?id=${product.id}">Add Cart</a></td>
				</tr>
			</tbody>
		</table>
	</div>
